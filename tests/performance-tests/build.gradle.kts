...
dependencies {
    ...
    // JMH (Java Microbenchmark Harness) - 从gradle.properties读取版本
    testImplementation("org.openjdk.jmh:jmh-core:${property("version.jmh")}")
    testAnnotationProcessor("org.openjdk.jmh:jmh-generator-annprocess:${property("version.jmh")}")
